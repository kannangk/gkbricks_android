...
public abstract class Hilt_DeliveryHomeFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeliveryHomeFragment_GeneratedInjector) this.generatedComponent()).injectDeliveryHomeFragment(UnsafeCasts.<DeliveryHomeFragment>unsafeCast(this));
    }
  }
