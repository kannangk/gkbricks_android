...
public abstract class Hilt_AddChamberUnloadingLogsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddChamberUnloadingLogsFragment_GeneratedInjector) this.generatedComponent()).injectAddChamberUnloadingLogsFragment(UnsafeCasts.<AddChamberUnloadingLogsFragment>unsafeCast(this));
    }
  }
