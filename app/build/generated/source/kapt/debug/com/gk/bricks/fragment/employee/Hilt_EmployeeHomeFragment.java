...
public abstract class Hilt_EmployeeHomeFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EmployeeHomeFragment_GeneratedInjector) this.generatedComponent()).injectEmployeeHomeFragment(UnsafeCasts.<EmployeeHomeFragment>unsafeCast(this));
    }
  }
