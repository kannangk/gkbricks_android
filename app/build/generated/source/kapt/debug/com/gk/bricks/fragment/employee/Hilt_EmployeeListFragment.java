...
public abstract class Hilt_EmployeeListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EmployeeListFragment_GeneratedInjector) this.generatedComponent()).injectEmployeeListFragment(UnsafeCasts.<EmployeeListFragment>unsafeCast(this));
    }
  }
