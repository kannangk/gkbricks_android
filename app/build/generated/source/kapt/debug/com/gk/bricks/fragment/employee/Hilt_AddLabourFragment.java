...
public abstract class Hilt_AddLabourFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddLabourFragment_GeneratedInjector) this.generatedComponent()).injectAddLabourFragment(UnsafeCasts.<AddLabourFragment>unsafeCast(this));
    }
  }
