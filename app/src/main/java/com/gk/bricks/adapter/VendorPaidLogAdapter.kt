...
import com.gk.bricks.util.vendorLoadItemMap
...
class VendorPaidLogAdapter(
    private val mContext: Context,
    private val list: List<VendorPaidLog>
) :
    RecyclerView.Adapter<VendorPaidLogAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val tvLoadAmount: TextView = view.findViewById(R.id.tvLoadAmount)
        val tvPaid: TextView = view.findViewById(R.id.tvPaid)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.vendor_log_list_row, parent, false)
