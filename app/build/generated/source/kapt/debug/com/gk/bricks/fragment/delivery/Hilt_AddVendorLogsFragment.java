...
public abstract class Hilt_AddVendorLogsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddVendorLogsFragment_GeneratedInjector) this.generatedComponent()).injectAddVendorLogsFragment(UnsafeCasts.<AddVendorLogsFragment>unsafeCast(this));
    }
  }
