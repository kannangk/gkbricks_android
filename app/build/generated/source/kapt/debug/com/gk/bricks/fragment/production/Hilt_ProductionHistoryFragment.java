...
public abstract class Hilt_ProductionHistoryFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductionHistoryFragment_GeneratedInjector) this.generatedComponent()).injectProductionHistoryFragment(UnsafeCasts.<ProductionHistoryFragment>unsafeCast(this));
    }
  }
