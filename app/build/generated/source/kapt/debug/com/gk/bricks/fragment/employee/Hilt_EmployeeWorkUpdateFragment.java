...
public abstract class Hilt_EmployeeWorkUpdateFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EmployeeWorkUpdateFragment_GeneratedInjector) this.generatedComponent()).injectEmployeeWorkUpdateFragment(UnsafeCasts.<EmployeeWorkUpdateFragment>unsafeCast(this));
    }
  }
