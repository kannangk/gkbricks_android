...
public abstract class Hilt_AddVendorFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddVendorFragment_GeneratedInjector) this.generatedComponent()).injectAddVendorFragment(UnsafeCasts.<AddVendorFragment>unsafeCast(this));
    }
  }
