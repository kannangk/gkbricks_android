...
public abstract class Hilt_EmployeeSalaryIndiviualFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EmployeeSalaryIndiviualFragment_GeneratedInjector) this.generatedComponent()).injectEmployeeSalaryIndiviualFragment(UnsafeCasts.<EmployeeSalaryIndiviualFragment>unsafeCast(this));
    }
  }
