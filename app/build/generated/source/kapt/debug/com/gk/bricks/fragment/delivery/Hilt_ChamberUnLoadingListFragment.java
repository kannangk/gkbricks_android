...
public abstract class Hilt_ChamberUnLoadingListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChamberUnLoadingListFragment_GeneratedInjector) this.generatedComponent()).injectChamberUnLoadingListFragment(UnsafeCasts.<ChamberUnLoadingListFragment>unsafeCast(this));
    }
  }
