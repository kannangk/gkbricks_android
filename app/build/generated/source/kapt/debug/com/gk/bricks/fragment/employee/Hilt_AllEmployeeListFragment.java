...
public abstract class Hilt_AllEmployeeListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AllEmployeeListFragment_GeneratedInjector) this.generatedComponent()).injectAllEmployeeListFragment(UnsafeCasts.<AllEmployeeListFragment>unsafeCast(this));
    }
  }
