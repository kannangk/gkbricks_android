...
public abstract class Hilt_ChamberIndiviualFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChamberIndiviualFragment_GeneratedInjector) this.generatedComponent()).injectChamberIndiviualFragment(UnsafeCasts.<ChamberIndiviualFragment>unsafeCast(this));
    }
  }
