...
public abstract class Hilt_ChamberLoadingListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChamberLoadingListFragment_GeneratedInjector) this.generatedComponent()).injectChamberLoadingListFragment(UnsafeCasts.<ChamberLoadingListFragment>unsafeCast(this));
    }
  }
