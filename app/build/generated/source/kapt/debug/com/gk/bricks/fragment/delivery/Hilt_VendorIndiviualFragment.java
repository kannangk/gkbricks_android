...
public abstract class Hilt_VendorIndiviualFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VendorIndiviualFragment_GeneratedInjector) this.generatedComponent()).injectVendorIndiviualFragment(UnsafeCasts.<VendorIndiviualFragment>unsafeCast(this));
    }
  }
