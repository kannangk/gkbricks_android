...
public abstract class Hilt_ChamberUnloadingIndiviualFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChamberUnloadingIndiviualFragment_GeneratedInjector) this.generatedComponent()).injectChamberUnloadingIndiviualFragment(UnsafeCasts.<ChamberUnloadingIndiviualFragment>unsafeCast(this));
    }
  }
