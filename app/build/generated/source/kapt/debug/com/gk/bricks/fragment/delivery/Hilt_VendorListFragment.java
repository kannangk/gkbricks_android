...
public abstract class Hilt_VendorListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VendorListFragment_GeneratedInjector) this.generatedComponent()).injectVendorListFragment(UnsafeCasts.<VendorListFragment>unsafeCast(this));
    }
  }
